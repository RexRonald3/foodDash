...
let Favourite_item;
let Fav_Object={
    "● Indian Kaju Katli": false,
    "● Grilled Chicken and Caesar Salad":false,
    "● Chicken , Prawns and Veggies Plater":false,
    "● Gobi Manchurian":false,
    "● Chicken Manchurian":false,
    "● Butter Chicken":false,
    "● Roasted Mushrooms":false,
    "● Masala Dosa":false,
    "● Non - Veg Meals":false,
    "● Special Briyani":false,
    "● Veg Briyani":false,
    "● Choco - Cheese Cake":false,
    "● Ice - Cream Bowl":false,
    "● Orange Juice":false,
    "● Blueberry Shake":false
};
function Open_home2_expanded_Card(element) {
    ...
    if(home2_expanded_Food_Name.innerText=="Indian Kaju Katli"){
        ...
        Favourite_item='● Indian Kaju Katli';
        ...
        Favourite_item='● Grilled Chicken and Caesar Salad';
        document.querySelector(".home2_expanded_AddToCart_button").onclick=function(){
        ...
        Favourite_item='● Chicken , Prawns and Veggies Plater';
        document.querySelector(".home2_expanded_AddToCart_button").onclick=function(){
            AddToCart('● Chicken , Prawns and Veggies Plater');
        }
    }
    Add_To_Favourites_home2(Favourite_item);
    setTimeout(() => {
...
function Open_Menu_expanded_FoodCard(element){
    ...
    if(Menu_expanded_Food_Name.textContent=="Gobi Manchurian"){
        ...
        Favourite_item='● Gobi Manchurian';
        ...
        Favourite_item='● Chicken Manchurian';
        document.querySelector(".Menu_expanded_AddToCart_button").onclick=function(){
        ...
        Favourite_item='● Roasted Mushrooms';
        document.querySelector(".Menu_expanded_AddToCart_button").onclick=function(){
        ...
        Menu_expanded_foods_price_info.textContent="$300";
        Favourite_item='● Special Briyani';
        document.querySelector(".Menu_expanded_AddToCart_button").onclick=function(){
        ...
        Menu_expanded_foods_price_info.textContent="$150";
        Favourite_item='● Choco - Cheese Cake';
        document.querySelector(".Menu_expanded_AddToCart_button").onclick=function(){
        ...
        Favourite_item='● Blueberry Shake';
        document.querySelector(".Menu_expanded_AddToCart_button").onclick=function(){
            AddToCart('● Blueberry Shake');
        }
    }
    Add_To_Favourites_Menu(Favourite_item);
    setTimeout(() => {
...
function Click_To_Favourites_home2(){
...
function Add_To_Favourites_home2(item){
    if(Fav_Object[item]==false){
        //alert(item+""+Fav_Object[item]);
        document.querySelector("#Cross_Expanded_home2_FoodCard").style.color="black";
    }
    else{
        //alert(Fav_Object[item]);
        document.querySelector("#Cross_Expanded_home2_FoodCard").style.color="red";
    }
}
function Add_To_Favourites_Menu(item){
    if(Fav_Object[item]==false){
        //alert(item+""+Fav_Object[item]);
        document.querySelector("#Cross_Expanded_Menu_FoodCard").style.color="black";
    }
...
function AddToCart(foodName){
    ...
    document.querySelector(".home2_ExpandedCard_notification").style.backgroundColor='green';
    document.querySelector(".Menu_ExpandedCard_notification").style.backgroundColor="green";
    document.querySelector(".home2_ExpandedCard_notification").innerHTML='Item Added to Cart!!!';
    document.querySelector(".Menu_ExpandedCard_notification").innerHTML="Item Added to Cart!!!";
...
//this file upload function is Not my code (chat GPT)
let file;
...
function View_Favourites(){
    document.querySelector(".favourites_background").style.display="flex";
    document.querySelector(".favorites_card").style.display="block";
    document.querySelector(".Favourites_UL_List").innerHTML=""; 
    for(let key in Fav_Object){
    if((Fav_Object[key])==true){
        let Fav_li=document.createElement("li");
        Fav_li.innerText=key;
        document.querySelector(".Favourites_UL_List").appendChild(Fav_li); 
    }
}
}

function Close_favourites(){
    document.querySelector(".favourites_background").style.display="none";
    document.querySelector(".favorites_card").style.display="none";
}